...
angle_pid = pid.PID(0.8, 0.04, 0.3, 200, 100)  # Constructs PID class for when the robot needs to rotate
forward_pid = pid.PID(0.3, 0.03, 0.01, 100,
                      100)  # Constructs PID class for when the robot needs to move forwards and backwards
...
current_angle = 100  # This value will be given by Amanda and Tara's function
current_distance = 1  # This value will be given by Amanda and Tara's function

for i in range(200):
    motor_pwm = angle_pid.get_output(i, 100)
